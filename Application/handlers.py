...
from Application.container import Application
from Application.controller import Controller
from Application.eventBus import EventBus
from Domain.AnomalyAlign import Aligner


# @EventBus.on("transform_img")
# @inject
# def handle_transform_img(
#         path:str,
#         save_path:str,
#         controller: Controller = Provide[Application.controller],
# ) -> Optional[str]:
#     print("handle_transform_img")
#     img = cv2.imread(path, cv2.IMREAD_COLOR)
#     if img is not None:
#         sleep(1.0)
#         print("saved img")
#         return save_mat_to_folder(img, save_path)
#     return None
...
@CommandBus.handler("align_task", executor="thread", ordered=True)
@inject
